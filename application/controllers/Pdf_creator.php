...
public function __construct(){
    ...
    public function index(){
        ...
        $pdf->SetXY(185,6);
        $pdf->cell(20,10,"asd",0,0,'L',false,'',1);
        $pdf->SetTextColor(0,0,0);
        $pdf->SetXY(59,34);
        $pdf->cell(128,5,"asdd",0,0,'L',false,'',1);
    ...
    public function recibo_pdf(){
        if(isset($this->session->userdata['logged_in'])){
            ...
            if($this->form_validation->run()==FALSE){
                ...
                $this->load->view('barra_nav',array('admin_priv'=>$this->session->userdata['logged_in']['privilegios']));
                ...
                if($result!=FALSE){
                    ...
                    $pdf->SetTextColor(0,0,0);
                    $pdf->SetXY(10,188);
                    $pdf->cell(77,5,$result['nombre'],0,0,'L',false,'',1);
                    //$pdf->SetXY(63,190);
                    //$pdf->cell(124,5,$result['fec_nac'],0,0,'L',false,'',1);
                    //$pdf->SetXY(67,4,0,0,'L',false,'',1);
                    $pdf->SetXY(10,201);
                    $pdf->cell(77,5,$result['nombre_tutor'],0,0,'L',false,'',1);
                    $pdf->SetXY(10,215);
                    $pdf->cell(77,5,$result['domicilio'],0,0,'L',false,'',1);
                    //$pdf->SetXY(43,213);
                    //$pdf->cell(144,5,$result['telefono'],0,0,'L',false,'',1);
                    //$pdf->SetXY(76,221);
                    //$pdf->cell(111,5,$result['escuela'],0,0,'L',false,'',1);
                    ...
                    $pdf->cell(58,5,'11 al 29 de Julio del 2016',0,0,'L',false,'',1);
                    $pdf->SetXY(28,268);
                    $pdf->cell(81,5,$result['costo'],0,0,'L',false,'',1);
                    $pdf->SetXY(26,275.5);
                    $pdf->cell(83,5,$result['grupo'],0,0,'L',false,'',1);
                    $pdf->SetXY(175,169);
                    $pdf->cell(30,5,$result['f_registro'],0,0,'L',false,'',1);
                    ...
                    $pdf->SetXY(143,177.8);
                    $pdf->cell(50,3,$result['curso'],0,0,'L',false,'',1);
                    $pdf->SetXY(148.5,185.3);
                    $pdf->cell(45,3,$result['nombre'],0,0,'L',false,'',1);
                    $pdf->SetXY(148,189.2);
                    $pdf->cell(45,3,$result['plantel'],0,0,'L',false,'',1);
                    $pdf->SetTextColor(255,255,255);
                    $pdf->SetXY(105,197);
                    $pdf->cell(35,3,$result['domicilio'],0,0,'L',false,'',1);
                    $pdf->SetXY(108,206);
                    $pdf->cell(35,3,$result['grupo'],0,0,'L',false,'',1);
                    $pdf->SetXY(111,214);
                    $pdf->cell(35,3,'11 al 29 de Julio del 2016',0,0,'L',false,'',1);
                    $pdf->SetTextColor(0,0,0);
                    $pdf->SetXY(103,225);
                    $pdf->cell(43,3,$result['taller'],0,0,'L',false,'',1);
                    $pdf->SetXY(178.5,225.4);
                    $pdf->cell(15,3,$fol,0,0,'L',false,'',1);
